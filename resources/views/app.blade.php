    ...
    <div class="left-sidenav">
      ...
      <div class="menu-content h-100" data-simplebar>
        <ul class="metismenu left-sidenav-menu">
          ...
          <li>
            <a href="javascript: void(0);"
              ><i data-feather="lock" class="align-self-center menu-icon"></i><span>Authentications</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span
            ></a>
            <ul class="nav-second-level" aria-expanded="false">
              <li class="nav-item">
            ...
            <ul class="nav-second-level" aria-expanded="false">
              <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                    <a href="ui-offcanvas.html">Offcanvas <span class="badge badge-soft-success ms-auto">New</span></a>
                  </li>
