                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 74.2px;" aria-label="Nomor: activate to sort column ascending">Jenis Kelamin</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 34.2px;" aria-label="Email: activate to sort column ascending">Email</th>
                                           ...
                                           @foreach ($Pasien as $ps)
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a id="bElim" type="button" class="btn btn-sm btn-soft-danger btn-circle" href=""><i class="dripicons-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
